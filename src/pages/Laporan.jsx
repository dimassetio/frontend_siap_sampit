// File: src/pages/LaporanIndex.jsx
    ...
    <AdminLayout>
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div class="col">
            <h2 className="text-2xl font-semibold">Data Laporan</h2>
            <p className="mt-2 text-gray-500">Kelola data laporan mahasiswa</p>
          </div>
          <DownloadLaporan />
        </div>
              ...
              {reports && reports.map((laporan, i) => (
                <tr key={laporan.id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-2 space-x-2">
                    <button
                      onClick={() => navigate(`/admin/reports/detail/${laporan._id}`)}
